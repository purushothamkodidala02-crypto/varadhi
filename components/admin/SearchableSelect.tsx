...
export function SearchableSelect({ name, value, onChange, options, placeholder, disabled = false, emptyMessage = "No matching options.", showOptionsOnEmpty = true }: SearchableSelectProps) {
