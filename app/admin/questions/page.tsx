...
export default async function AdminQuestionsPage() {
  ...
  return (
    <div>
      <header className="flex flex-wrap items-end justify-between gap-5"><div><p className="text-xs font-bold uppercase tracking-[0.15em] text-teal-700">Content library</p><h1 className="mt-2 text-3xl font-black tracking-tight text-slate-950 sm:text-4xl">Question bank</h1><p className="mt-3 max-w-2xl leading-7 text-slate-600">Choose an exam category first, then its Exam and subject before adding a reusable question.</p></div><a href="#add-question" className="rounded-xl bg-slate-950 px-4 py-3 text-sm font-bold text-white shadow-sm transition hover:bg-slate-800">+ Add question</a></header>
