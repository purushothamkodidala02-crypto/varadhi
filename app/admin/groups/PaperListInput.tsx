...
function newPaper(key: number): PaperDraft {
  return { key, name: "", duration_minutes: "", question_count: "", default_correct_marks: "1", default_negative_marks: "0" };
}
